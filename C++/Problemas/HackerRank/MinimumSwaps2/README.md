...
You are given an unordered array consisting of consecutive integers \(\in [1, 2, 3, \dots, n]\) without any duplicates. You are allowed to swap any two elements. Find the minimum number of swaps required to sort the array in ascending order. 
...
After swapping $(2, 3)$ we get:

$$
arr: [2, 3, 1, 4, 5]
$$

After swapping $(0, 1)$ we get: 
