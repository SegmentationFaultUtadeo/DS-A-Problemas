...
The first line of input gives the number of test cases, $1 \leq t \leq 100$. There are two lines for each test
case. The first gives the number of stores Michael wants to visit, $1 \leq n \leq 20$, and the second gives their $n$ integer positions on Long Street, $0 \leq x_i \leq 99$.
