...
Many well-known cryptogrhapic operations require modular exponentiation. That is, given integers $x$, $y$ and $n$, compute $x^y \mod n$. In this question, you are tasked to program an efficient way to execute
this calculation.
...
blanks. You can assume that $1 < x, n < 2^15 = 32768$, and $0 < y < 2^31$ = 2147483648.
...
for the numbers $x, y, z$ given the $i$-th input dataset.
